...
import {
  ...
  mustChangePassword,
}                         from './core/router.js?v=20260806d';
import { loadSession }    from './utils/storage.js?v=20260806d';
import { ToastContainer } from './components/base/UI.js?v=20260806d';
import { initAvatarLightbox } from './utils/avatarLightbox.js?v=20260806d';
...
router.register('web', [
...

  {
    ...
    path:      '/',
    component: () => import('./pages/web/auth/SelectRegion.js?v=20260806d'),
    guards:    [],
  ...
  {
    path:      '/west',
    component: () => import('./pages/web/auth/WestLanding.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Lagos West Connect' },
  },
  {
    path:      '/central',
    component: () => import('./pages/web/auth/CentralLanding.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Lagos Central Connect' },
  },
  {
    path:      '/east',
    component: () => import('./pages/web/auth/EastLanding.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
  ...
  {
    path:      '/terms',
    component: () => import('./pages/web/auth/TermsPage.js?v=20260806d'),
    guards:    [],
...

  {
    ...
    component: () => import('./pages/web/auth/NewsletterUnsubscribe.js?v=20260806d'),
    guards:    [],
  ...
  {
    path:      '/login',
    component: () => import('./pages/web/auth/Login.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Log In' },
  },
  {
    path:      '/signup',
    component: () => import('./pages/web/auth/Signup.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Create Account' },
  },
  {
    path:      '/2fa',
    component: () => import('./pages/web/auth/TwoFactorLogin.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Two-Factor Authentication' },
  },
  {
    path:      '/oauth/callback',
    component: () => import('./pages/web/auth/OAuthCallback.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'OAuth Callback' },
  },
  {
    path:      '/verify-phone',
    component: () => import('./pages/web/auth/VerifyPhone.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Verify Phone' },
  },
  {
    path:      '/forgot-password',
    component: () => import('./pages/web/auth/ForgotPassword.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Forgot Password' },
  },
  {
    path:      '/verify-identity',
    component: () => import('./pages/web/auth/VerifyIdentity.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
    meta:      { title: 'Verify Identity' },
  },
  {
    path:      '/reset-credentials',
    component: () => import('./pages/web/auth/ResetCredentials.js?v=20260806d'),
    guards:    [redirectIfAuthenticated],
...

  {
    ...
    component: () => import('./pages/web/auth/ForceChangePassword.js?v=20260806d'),
  ...
  },
  {
    ...
    path:      '/welcome',
    component: () => import('./pages/web/app/Welcome.js?v=20260806d'),
...

  {
    ...
    path:      '/home',
    component: () => import('./pages/web/app/Home.js?v=20260806d'),
    guards:    [({ next }) => next(`/${getRegion()}/home`)],
    meta:      { title: 'Home' },
  },
  {
    path:      '/news',
    component: () => import('./pages/web/app/News.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'News' },
  },
  {
    path:      '/news/:slug',
    component: () => import('./pages/web/app/NewsDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Article' },
  },
  {
    path:      '/reels',
    component: () => import('./pages/web/app/Reels.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reels' },
  },
  {
    path:      '/reels/:reelId',
    component: () => import('./pages/web/app/ReelDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reel' },
  },
  {
    path:      '/referrals',
    component: () => import('./pages/web/app/Referrals.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Referral Programme' },
  },
  {
    path:      '/chat',
    component: () => import('./pages/web/app/Chat.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Community Chat' },
  },
  {
    path:      '/notifications',
    component: () => import('./pages/web/app/Notifications.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Notifications' },
  },
  {
    path:      '/settings',
    component: () => import('./pages/web/app/Settings.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Settings' },
  },
  {
    path:      '/profile',
    component: () => import('./pages/web/app/Profile.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'My Profile' },
  },
  {
    path:      '/u/:username',
    component: () => import('./pages/web/app/UserProfile.js?v=20260806d'),
    meta:      { title: 'Profile' },
  },
  ...
  {
    path:      '/west/welcome',
    component: () => import('./pages/web/west/Welcome.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Welcome — Lagos West' },
  },
  {
    path:      '/west/home',
    component: () => import('./pages/web/west/Home.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Home — Lagos West' },
  },
  {
    path:      '/west/news',
    component: () => import('./pages/web/west/News.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'News — Lagos West' },
  },
  {
    path:      '/west/news/:slug',
    component: () => import('./pages/web/west/NewsDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Article — Lagos West' },
  },
  {
    path:      '/west/reels',
    component: () => import('./pages/web/west/Reels.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reels — Lagos West' },
  },
  {
    path:      '/west/reels/:reelId',
    component: () => import('./pages/web/west/ReelDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reel — Lagos West' },
  },
  {
    path:      '/west/referrals',
    component: () => import('./pages/web/west/Referrals.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Referral Programme — Lagos West' },
  },
  {
    path:      '/west/chat',
    component: () => import('./pages/web/west/Chat.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Community Chat — Lagos West' },
  },
  {
    path:      '/west/notifications',
    component: () => import('./pages/web/west/Notifications.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Notifications — Lagos West' },
  },
  {
    path:      '/west/settings',
    component: () => import('./pages/web/west/Settings.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Settings — Lagos West' },
  },
  {
    path:      '/west/profile',
    component: () => import('./pages/web/west/Profile.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'My Profile — Lagos West' },
  },
  {
    path:      '/west/u/:username',
    component: () => import('./pages/web/west/UserProfile.js?v=20260806d'),
...

  {
    ...
    component: () => import('./pages/web/central/Welcome.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Welcome — Lagos Central' },
  },
  {
    path:      '/central/home',
    component: () => import('./pages/web/central/Home.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Home — Lagos Central' },
  },
  {
    path:      '/central/news',
    component: () => import('./pages/web/central/News.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'News — Lagos Central' },
  },
  {
    path:      '/central/news/:slug',
    component: () => import('./pages/web/central/NewsDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Article — Lagos Central' },
  },
  {
    path:      '/central/reels',
    component: () => import('./pages/web/central/Reels.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reels — Lagos Central' },
  },
  {
    path:      '/central/reels/:reelId',
    component: () => import('./pages/web/central/ReelDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reel — Lagos Central' },
  },
  {
    path:      '/central/referrals',
    component: () => import('./pages/web/central/Referrals.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Referral Programme — Lagos Central' },
  },
  {
    path:      '/central/chat',
    component: () => import('./pages/web/central/Chat.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Community Chat — Lagos Central' },
  },
  {
    path:      '/central/notifications',
    component: () => import('./pages/web/central/Notifications.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Notifications — Lagos Central' },
  },
  {
    path:      '/central/settings',
    component: () => import('./pages/web/central/Settings.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Settings — Lagos Central' },
  },
  {
    path:      '/central/profile',
    component: () => import('./pages/web/central/Profile.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'My Profile — Lagos Central' },
  },
  {
    path:      '/central/u/:username',
    component: () => import('./pages/web/central/UserProfile.js?v=20260806d'),
  ...
  {
    path:      '/east/welcome',
    component: () => import('./pages/web/east/Welcome.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Welcome — Lagos East' },
  },
  {
    path:      '/east/home',
    component: () => import('./pages/web/east/Home.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Home — Lagos East' },
  },
  {
    path:      '/east/news',
    component: () => import('./pages/web/east/News.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'News — Lagos East' },
  },
  {
    path:      '/east/news/:slug',
    component: () => import('./pages/web/east/NewsDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Article — Lagos East' },
  },
  {
    path:      '/east/reels',
    component: () => import('./pages/web/east/Reels.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reels — Lagos East' },
  },
  {
    path:      '/east/reels/:reelId',
    component: () => import('./pages/web/east/ReelDetail.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Reel — Lagos East' },
  },
  {
    path:      '/east/referrals',
    component: () => import('./pages/web/east/Referrals.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Referral Programme — Lagos East' },
  },
  {
    path:      '/east/chat',
    component: () => import('./pages/web/east/Chat.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Community Chat — Lagos East' },
  },
  {
    path:      '/east/notifications',
    component: () => import('./pages/web/east/Notifications.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Notifications — Lagos East' },
  },
  {
    path:      '/east/settings',
    component: () => import('./pages/web/east/Settings.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'Settings — Lagos East' },
  },
  {
    path:      '/east/profile',
    component: () => import('./pages/web/east/Profile.js?v=20260806d'),
    guards:    [requireAuth, requireCitizen],
    meta:      { title: 'My Profile — Lagos East' },
  },
  {
    path:      '/east/u/:username',
    component: () => import('./pages/web/east/UserProfile.js?v=20260806d'),
  ...
  {
    path:      '/404',
    component: () => import('./pages/web/NotFound.js?v=20260806d'),
...
router.register('admin', [
...

  {
    ...
    path:      '/admin/login',
    component: () => import('./pages/admin/auth/AdminLogin.js?v=20260806d'),
    guards:    [],
  ...
  {
    path:      '/admin',
    component: () => import('./pages/admin/app/Dashboard.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Dashboard' },
  },
  {
    path:      '/admin/users',
    component: () => import('./pages/admin/app/Users.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  {
    path:      '/admin/news',
    component: () => import('./pages/admin/app/News.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'News Management' },
  },
  {
    path:      '/admin/news/new',
    component: () => import('./pages/admin/app/NewsForm.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  },
  {
    ...
    component: () => import('./pages/admin/app/NewsImport.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Import News' },
  },
  {
    path:      '/admin/withdrawals',
    component: () => import('./pages/admin/app/Withdrawals.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Referral Payouts' },
  },
  {
    path:      '/admin/news/:id',
    component: () => import('./pages/admin/app/NewsView.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  },
  {
    ...
    component: () => import('./pages/admin/app/NewsPreview.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  {
    path:      '/admin/reels',
    component: () => import('./pages/admin/app/AdminReels.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Reels Management' },
  },
  {
    path:      '/admin/reels/new',
    component: () => import('./pages/admin/app/AdminReelForm.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  },
  {
    ...
    component: () => import('./pages/admin/app/AdminReelPreview.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  /* Content & chat */
  {
    ...
    component: () => import('./pages/admin/app/AdminContentModeration.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Content Moderation' },
  },
  {
    path:      '/admin/chat',
    component: () => import('./pages/admin/app/ChatManagement.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  },
  {
    ...
    component: () => import('./pages/admin/app/ReferralLeaderboard.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  {
    path:      '/admin/adverts',
    component: () => import('./pages/admin/app/AdminAdverts.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Advert Management' },
  },
  {
    path:      '/admin/adverts/new',
    component: () => import('./pages/admin/app/AdminAdvertForm.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  },
  {
    ...
    component: () => import('./pages/admin/app/AdminAdvertPreview.js?v=20260806d'),
    guards:    [requireAdmin],
  ...
  {
    path:      '/admin/lga-data',
    component: () => import('./pages/admin/app/AdminLGA.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'LGA Data' },
  },
   {
     path:      '/admin/analytics',
     component: () => import('./pages/admin/app/Analytics.js?v=20260806d'),
     guards:    [requireAdmin],
     meta:      { title: 'Governance Analytics' },
   },
   {
     path:      '/admin/active-users',
     component: () => import('./pages/admin/app/ActiveUsers.js?v=20260806d'),
     guards:    [requireAdmin],
     meta:      { title: 'Top Active Users' },
   },
   {
     path:      '/admin/traffic',
    component: () => import('./pages/admin/app/Traffic.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Site Traffic' },
  },
  {
    path:      '/admin/settings',
    component: () => import('./pages/admin/app/AdminSettings.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Platform Settings' },
  },
  {
    path:      '/admin/management',
    component: () => import('./pages/admin/app/AdminManagement.js?v=20260806d'),
    guards:    [requireAdmin],
...

  {
    ...
    path:      '/admin/404',
    component: () => import('./pages/admin/NotFound.js?v=20260806d'),
    guards:    [requireAdmin],
    meta:      { title: 'Page Not Found' },
  },
  {
