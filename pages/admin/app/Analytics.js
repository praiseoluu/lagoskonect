...
import { BarChart, TopicsChart, HeatmapChart, TrendCard } from '../../../components/charts/Charts.js?v=20260806c';
...
export default class AnalyticsPage extends AdminLayout {
  static styles = '/pages/admin/app/Analytics.css?v=20260806c';
