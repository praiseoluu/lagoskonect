...
import { Badge } from '../../../components/base/Badge.js?v=20260806f';
...
export default class NewsDetailPage extends WebLayout {
  static styles = '/pages/web/app/NewsDetail.css?v=20260806f';
  ...
  async onContentReady() {
    ...
    if (!slug) { router.replace('/west/news'); return; }
    ...
    if (res.error || !res.data) {
      inner.innerHTML = `
        <div class="news-detail-not-found">
          ...
          <a href="/west/news" class="ktg-btn ktg-btn--ghost ktg-btn--md">← ${this.esc(t('newsDetail.backToNews'))}</a>
        </div>
      `;
      return;
    }
  ...
  _renderArticle(item) {
    ...
    inner.innerHTML = `
      <div class="news-detail-container">
        ...
        <!-- Back link -->
        <a href="/west/news" class="news-detail-back">
