...
import { NewsCard } from '../../../components/base/Card.js?v=20260806d';
import { ReelCard } from '../../../components/base/Card.js?v=20260806d';
...
export default class HomePage extends WebLayout {
  ...
  static styles = '/pages/web/app/Home.css?v=20260806d';
    ...
    root.innerHTML = `
      ...
      <section class="home-quick-actions" aria-labelledby="quick-actions-heading">
        ...
        <div class="home-quick-actions__grid">
          <a class="home-quick-action" href="/west/news">
          ...
          <a class="home-quick-action" href="/west/chat">
            <span class="home-quick-action__icon" aria-hidden="true">
      ...
      ${this._reels.length ? `
        <section class="home-section" aria-labelledby="reels-heading">
          <div class="home-section__header">
            ...
            <a href="/west/reels" class="home-section__link">${this.esc(t('home.seeAll'))}<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg></a>
          </div>
      ...
      <div class="home-bottom-row">
        ...
        <section class="home-section home-section--news" aria-labelledby="news-heading">
          <div class="home-section__header">
            ...
            <a href="/west/news" class="home-section__link">${this.esc(t('home.seeAll'))}<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg></a>
          </div>
  ...
  _bindCarousel(total) {
    ...
    this.delegate('.home-carousel__slide', 'click', (e, slide) => {
      ...
      if (slug) router.push(`/west/news/${slug}`);
    });
  ...
  async _mountReelCards() {
    ...
    for (const reel of this._reels) {
      ...
      const card = this.addChild(new ReelCard({
        ...reel,
        onClick: () => router.push(`/west/reels/${reel.reelId}`),
      }));
  ...
  async _mountNewsCards(items) {
    ...
    for (const item of items) {
      ...
      const card = this.addChild(new NewsCard({
        ...item,
        layout: 'horizontal',
        onClick: () => router.push(`/west/news/${item.slug || item.id}`),
      }));
      await card.mount(wrap);
    }
  }
  ...
  _bindChatBtn() {
    ...
    if (btn) this.on(btn, 'click', () => router.push('/west/chat'));
  }
