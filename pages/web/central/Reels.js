...
export default class ReelsPage extends WebLayout {
  static styles = '/pages/web/app/Reels.css?v=20260806e';
  ...
  _togglePlay(item) {
    ...
    if (video.paused) { video.play().catch(() => {}); }
      ...
      video.pause();
      if (pauseIco) { pauseIco.classList.add('rf-item__pause-icon--show'); setTimeout(() => pauseIco.classList.remove('rf-item__pause-icon--show'), 900); }
    }
  }
