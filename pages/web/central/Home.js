    ...
    root.innerHTML = `
      ...
      <section class="home-quick-actions" aria-labelledby="quick-actions-heading">
        ...
        <div class="home-quick-actions__grid">
          <a class="home-quick-action" href="/central/news">
          ...
          <a class="home-quick-action" href="/central/chat">
            <span class="home-quick-action__icon" aria-hidden="true">
      ...
      ${this._reels.length ? `
        <section class="home-section" aria-labelledby="reels-heading">
          <div class="home-section__header">
            ...
            <a href="/central/reels" class="home-section__link">${this.esc(t('home.seeAll'))}<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg></a>
          </div>
      ...
      <div class="home-bottom-row">
        ...
        <section class="home-section home-section--news" aria-labelledby="news-heading">
          <div class="home-section__header">
            ...
            <a href="/central/news" class="home-section__link">${this.esc(t('home.seeAll'))}<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg></a>
          </div>
