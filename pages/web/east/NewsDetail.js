...
export default class NewsDetailPage extends WebLayout {
  ...
  async onContentReady() {
    ...
    if (!slug) { router.replace('/east/news'); return; }
    ...
    if (res.error || !res.data) {
      inner.innerHTML = `
        <div class="news-detail-not-found">
          ...
          <a href="/east/news" class="ktg-btn ktg-btn--ghost ktg-btn--md">← ${this.esc(t('newsDetail.backToNews'))}</a>
        </div>
      `;
      return;
    }
  ...
  _renderArticle(item) {
    ...
    inner.innerHTML = `
      <div class="news-detail-container">
        ...
        <!-- Back link -->
        <a href="/east/news" class="news-detail-back">
