...
import { WebLayout }                        from '../layout/BaseLayout.js?v=20260807a';
import { router }                           from '../../core/router.js?v=20260807a';
import { store, setPageLoading }            from '../../core/store.js?v=20260807a';
...
export default class Onboarding extends WebLayout {
  static styles = '/pages/web/app/Welcome.css?v=20260807a';
