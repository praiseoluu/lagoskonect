 ...
 *
 * Usage:
 *   import { LanguageSwitcher } from './LanguageSwitcher.js?v=20260807a';
 *
...
export class LanguageSwitcher extends Component {
  static styles = '/components/feature/LanguageSwitcher.css?v=20260807a';
