 ...
 *
 * Usage:
 *   import { LanguageSwitcher } from './LanguageSwitcher.js?v=20260806g';
 *
...
export class LanguageSwitcher extends Component {
  static styles = '/components/feature/LanguageSwitcher.css?v=20260806g';
