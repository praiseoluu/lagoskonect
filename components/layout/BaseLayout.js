...
import { WebSidebar, AdminSidebar } from './Sidebar.js?v=20260806b';
import { WebTopbar, AdminTopbar }   from './Topbar.js?v=20260806b';
import { ToastContainer } from '../base/UI.js?v=20260806b';
import { store }          from '../../core/store.js?v=20260806b';
import { api }            from '../../api/client.js?v=20260806b';
import { CreateReelModal }  from '../feature/CreateReel.js?v=20260806b';
import { SelectLGAModal }   from '../feature/SelectLGAModal.js?v=20260806b';
...
export class BaseLayout extends Component {
  static styles = '/components/layout/BaseLayout.css?v=20260806b';
...
export class WebLayout extends BaseLayout {
  ...
  async afterMount() {
    ...
    if (!store.isAuthenticated || store.role !== 'citizen') {
      const { router } = await import('../../core/router.js?v=20260806b');
