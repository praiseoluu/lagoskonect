...
export class Sidebar extends Component {
  static styles = '/components/layout/Sidebar.css?v=20260806c';
    ...
    this.delegate('[data-logout]', 'click', async () => {
      try {
        const [{ clearSession }, { showToast }, { sseClient }] = await Promise.all([
          import('../../utils/storage.js?v=20260806c'),
          import('../../core/store.js?v=20260806c'),
          import('../../core/sseClient.js?v=20260806c'),
        ]);
